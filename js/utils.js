...
globalThis.RollerUtil = {
	...
	clearSeeds: function() {
		globalThis.RollerUtil.seedDictionary = {};
		globalThis.RollerUtil.randomFunction = Math.random;
	},

	setSeed: function(key) {
		if(!globalThis.RollerUtil.seedDictionary[key]) {
			// Create cyrb128 state:
			var bytesSeed = globalThis.RollerUtil.cyrb128(key);
			// Four 32-bit component hashes provide the seed for sfc32.
			globalThis.RollerUtil.seedDictionary[key] = globalThis.RollerUtil.sfc32(bytesSeed[0], bytesSeed[1], bytesSeed[2], bytesSeed[3]);
		}

		globalThis.RollerUtil.randomFunction = globalThis.RollerUtil.seedDictionary[key];
	},
	...
	roll (max, fn) {
		...
		return Math.floor(globalThis.RollerUtil.randomFunction() * max);
	},
